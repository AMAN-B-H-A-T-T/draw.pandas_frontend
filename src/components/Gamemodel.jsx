...
import { setPlayerList,updatePlayerCount} from '../redux/slices./gameSlice';

const Gamemodel = ({ openModal, setOpenModal,socket,setSocket,is_private_room_creator,set_is_private_room_creator,playerLists}) => {
    ...
    const startGame = ()=>{
        const data = {"room_id":gameData.room_id,"round_count":round_count}
                        ...
                        <div>
                            <div className="mb-2 flex space-x-4 items-center">
                                ...
                                <div className="relative flex items-center max-w-[11rem]">
                                    <button type="button" id="decrement-button" data-input-counter-decrement="bedrooms-input" className="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none" disabled = {is_private_room_creator ? false : true} onClick={(e)=>{e.preventDefault();round_count > 3 ? handleRoundchange(parseInt(round_count)-1) : null}}>
                                    ...
                                    <button type="button" id="increment-button" data-input-counter-increment="bedrooms-input" className="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none" onClick={(e)=>{e.preventDefault();round_count < 5 ? handleRoundchange(parseInt(round_count)+1)  : null;}} disabled = {is_private_room_creator ? false : true}>
